...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (anchored-transpose avy csv-mode go-mode shrink-whitespace linum-relative easy-kill zenburn-theme yasnippet which-key use-package squery smex register-channel rainbow-delimiters polymode multiple-cursors markdown-mode magit lua-mode iy-go-to-char ido-vertical-mode ido-ubiquitous haskell-mode guide-key goto-chg god-mode f ess edit-server change-inner browse-kill-ring base16-theme ace-window))))
