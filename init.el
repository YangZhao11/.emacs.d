...
(custom-set-faces
 ...
 '(vc-conflict-state ((t (:inherit vc-state-base :foreground "#E03030"))))
 '(vc-edited-state ((t (:inherit vc-state-base :foreground "#60CC80"))))
 '(vc-locally-added-state ((t (:inherit vc-state-base :foreground "#90E090"))))
