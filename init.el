...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (js2-mode loccur scala-mode2 clang-format markdown-mode use-package magit flycheck-status-emoji flycheck go-eldoc company company-go smex ack beacon anchored-transpose avy csv-mode go-mode shrink-whitespace easy-kill zenburn-theme yasnippet squery register-channel rainbow-delimiters multiple-cursors lua-mode ido-vertical-mode ido-ubiquitous haskell-mode guide-key goto-chg god-mode f ess edit-server change-inner browse-kill-ring base16-theme ace-window)))
