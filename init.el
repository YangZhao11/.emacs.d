...
(custom-set-variables
 ...
 '(compilation-error-regexp-alist
   '(google3-build-log-parser-info google3-build-log-parser-warning
                                   ...
                                   google3-build-log-parser-info
                                   google3-build-log-parser-warning
                                   google3-build-log-parser-error
                                   google3-build-log-parser-python-traceback
                                   google-go-cgo google-blaze-error
                                   google-log-error google-log-warning
                                   google-log-info
                                   google-log-fatal-message
                                   google-forge-python
                                   gunit-stack-trace absoft ada aix
                                   ant bash borland
                                   python-tracebacks-and-caml cmake
                                   cmake-info comma cucumber msft
                                   edg-1 edg-2 epc ftnchek iar ibm
                                   irix java jikes-file maven
                                   jikes-line clang-include
                                   clang-include gcc-include
                                   ruby-Test::Unit gnu lcc makepp
                                   mips-1 mips-2 msft omake oracle
                                   perl php rxp sparc-pascal-file
                                   sparc-pascal-line
                                   sparc-pascal-example sun sun-ada
                                   watcom 4bsd gcov-file gcov-header
                                   gcov-nomark gcov-called-line
                                   gcov-never-called
                                   perl--Pod::Checker perl--Test
 ...
 '(custom-safe-themes
   '("e8bd9bbf6506afca133125b0be48b1f033b1c8647c628652ab7a2fe065c10ef0"
     ...
     "ae1b8172198902655489ef133403e55cbfc2aff8147a9b7698196c4cb9bce8da"
...
(custom-set-faces
 ...
 '(corfu-current ((t (:extend t :background "#555" :foreground "#DCDCDC"))))
 '(dired-directory ((t (:inherit font-lock-function-name-face :foreground "#93E0E3"))))
 '(font-lock-builtin-face ((t (:foreground "#CCDCEC" :weight normal))))
 ...
 '(secondary-selection ((t (:extend t :background "#555"))))
 '(shadow ((t (:foreground "#777"))))
 '(show-paren-match ((default (:background "#303030" :box (:line-width (-1 . -1) :color "#93E0E3" :style flat-button) :weight bold)) (((type nil)) (:underline t))))
 ...
 '(vertico-current ((t (:extend t :background "#555"))))
