...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel swiper citc g4-gutter ivy imenu-anywhere wgrep ivy-hydra flx hydra keyfreq color-identifiers-mode org-bullets js2-mode loccur scala-mode2 clang-format markdown-mode use-package magit flycheck-status-emoji flycheck go-eldoc company company-go smex beacon anchored-transpose avy csv-mode go-mode easy-kill zenburn-theme yasnippet squery register-channel rainbow-delimiters lua-mode ido-vertical-mode ido-ubiquitous haskell-mode goto-chg god-mode f ess edit-server ace-window)))
