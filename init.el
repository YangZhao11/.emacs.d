...
=======
    (smex wgrep ivy-hydra counsel swiper hydra color-identifiers-mode org-bullets js2-mode scala-mode2 clang-format markdown-mode use-package magit flycheck-status-emoji flycheck go-eldoc company company-go beacon anchored-transpose avy csv-mode go-mode easy-kill zenburn-theme yasnippet squery register-channel rainbow-delimiters lua-mode haskell-mode goto-chg god-mode f ess edit-server browse-kill-ring ace-window)))
>>>>>>> deaddf470aadfc3109e5221983877f9375102d77
