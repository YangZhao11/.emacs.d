...
(defvar easy-kill--exit-fun nil
  "function to deactivate easy-kill transient map")
(defun easy-kill-exit ()
  "Exit easy-kill mode. Can only be called when easy-kill is active."
  (when easy-kill--exit-fun
    (funcall easy-kill--exit-fun)
    (setq easy-kill--exit-fun nil)))

(defun easy-kill-activate-keymap ()
  (let ((map (easy-kill-map)))
    (setq easy-kill--exit-fun
          (set-transient-map
     map
     (lambda ()
