...
(define-abbrev-table 'gtags-browse-tags-mode-abbrev-table '())
...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("calcd" "calculated" nil 2)
    ("calcn" "calculation" nil 3)
    ("cdd" "candidate" nil 32)
    ("ci" "confidence interval" nil 4)
    ("ctl" "correctly" nil 0)
    ("diff" "difference" nil 1)
    ("dist" "distribution" nil 3)
    ("epd" "explained" nil 1)
    ...
    ("props" "proportions" nil 3)
    ("regn" "regression" nil 2)
    ("rlv" "relevant" nil 1)
    ("sp" "sample" nil 0)
    ("spl" "sampling" nil 5)
    ("srp" "Server reliability problem" nil 0)
    ("stat" "statistics" nil 4)
    ("statl" "statistical" nil 1)
