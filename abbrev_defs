...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("distn" "distribution" nil 13)
    ("ep" "explaine" nil 0)
    ("epd" "explained" nil 3)
    ("epn" "explanation" nil 1)
    ("eptn" "expectation" nil 0)
    ("est" "estimate" nil 6)
    ("estn" "estimation" nil 0)
    ("estr" "estimator" nil 0)
    ...
    ("ppsd" "proposed" nil 1)
    ("prm" "problem" nil 0)
    ("prob" "probability" nil 8)
    ("prog" "program" nil 4)
    ("propn" "proportion" nil 5)
